...
- **风格 1：经典极简黑白风 (Classic Minimalist)**
  - 纯白画布（黑线）或纯黑画布（白线），高对比度极简无脸线条，极佳的认知穿透力，最适合硬核知识、逻辑框架与思维模型。
- **风格 2A：现代潮酷 · 极简科技风 (Modern Studio Tech)**
  - 纯白高光空间 + 极淡浅灰透视地砖网格 + 悬浮青蓝半透明玻璃 UI/微光质感（Apple Keynote 级极简科技感，内置反杂乱负面提示词）。
- **风格 2B：现代潮酷 · 彩色故事风 (Cinematic Story)**
  - 全彩沉浸式场景（暖光卧室、黄昏窗前、荒野公路、云端山顶）+ 电影叙事光影（Pixar 故事短片风，角色始终保持 2D 线条）。

---

### 长期演进计划：打造火柴人全画风导演库

这是一个致力于把**全网所有高转化火柴人画风**全部规范化、工业化落地的长期开源合集。

<div align="center">
  <img src="assets/readme/style-roadmap.png" alt="火柴人全画风路线图" width="750">
</div>

我们已经系统梳理了近 **10 种覆盖各大垂直赛道**的特色火柴人画风。如果社区反馈热烈，我们将保持**每 3~4 天持续更新上线一种新风格**：

1. **情景喜剧 / 双人对话风**：双角色互动、情感互怼、职场嘴替与日常吐槽
2. **2D 火柴人融入写实 3D 背景**：虚实次元碰撞、RPG 新手村冒险、奇幻穿越
3. **讲台名师 / 科普脱口秀风**：黑板教具互动、学者解说、严肃知识通俗化
4. **手绘绘本 / 骑士冒险风**：治愈成长手绘、古典寓言、温暖儿童科普
5. **热血涂鸦 / 武斗打戏风**：极简高燃动作分镜、连招对决、打击力量感
6. **史前洞穴 / 黑色幽默风**：历史反差萌、远古人类脑洞、趣味反转神剧
7. **爆款卡牌 / 闯关游戏风**：数值爽感爆发、升级进阶、解说与游戏推文

#### 接下来持续升级的三大方向：
1. **全画风矩阵覆盖**：把上图中的各种爆款画风逐一完成提示词标准化，适配全平台各大赛道创作者；
2. **打通爆款内容源**：拒绝让 AI 凭空瞎编，未来将基于全网爆款内容进行抓取、汇总和分类，提供针对性改编方案；
3. **独立 Web 影像工作台**：随着风格逐渐丰富，将推出可视化 Web 站点，方便实时预览各风格效果、一键匹配爆款文案并批量复制提示词。
...
2. **选择** `16:9`、`9:16` 或 `1:1`，再选择浅色或深色主题（或指定风格 2A 极简科技 / 风格 2B 彩色故事）。
...
- **速通实操全教程**：想要了解完整的 Flow 设置与薅羊毛姿势，推荐阅读烤妹儿的实操指引推文：[《白嫖谷歌！7 块钱解锁 18 个月 Pro：无限 Nano Banana 生图 ＋ 登顶第一的视频模型（附 Flow 速通全攻略）》](https://x.com/CrazyKaomei/status/2093893997223923822?s=20)。
...
如果你对路线图中的某个画风特别感兴趣，**欢迎在 Issue 中留言或 Star 仓库**。这会直接决定我们下一次优先更新哪种火柴人风格！
