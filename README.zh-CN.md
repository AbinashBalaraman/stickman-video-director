...
除了经典的黑白高对比火柴人，Skill 现已正式支持经过实测调校的**现代潮酷火柴人 (Modern Beanie Zeke)** 双细分流派：

- **风格 1：经典极简黑白风 (Classic Minimalist)**：纯白画布（黑线）或纯黑画布（白线），高对比度极简无脸线条，极佳的认知穿透力。
- **风格 2A：极简科技风 (Modern Studio Tech)**：纯白亮面高光空间 + 极淡浅灰透视地砖网格 + 悬浮青蓝半透明玻璃 UI/微光质感（Apple Keynote 级极简科技感）。
- **风格 2B：彩色故事风 (Cinematic Story)**：全彩沉浸式场景（暖光卧室、黄昏窗前、荒野公路、云端山顶）+ 电影叙事光影（Pixar 故事短片风）。
